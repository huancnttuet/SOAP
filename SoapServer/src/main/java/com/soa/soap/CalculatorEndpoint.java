...
import huan.soa.soap.GetSumResponse;
import huan.soa.soap.GetSumRequest;
...
public class CalculatorEndpoint {
    ...
    public GetSumResponse sum(@RequestPayload GetSumRequest request) {
        ...
        response.setResult(request.getFirstNumber() + request.getSecondNumber() +request.getThirdNumber());
